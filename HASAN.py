...
\033[1;34m--------------------------------------------------
\033[1;39m \033[0;91m𝙊𝙒𝙉𝙀𝙍    \033[1;39m: \033[1;33mHASAN
\033[1;39m \033[0;92m𝙔𝙊𝙐𝙏𝙐𝘽𝙀  \033[1;39m: \033[1;32m BS Gamer
\033[1;39m \033[0;93m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 \033[1;39m: \033[1;33mHASAN 卝 চৌধুরীヅ  
\033[1;39m \033[0;94m𝙁𝘽 𝙂𝙍𝙊𝙐𝙋 \033[1;39m: \033[1;34mHASAN11
...
def menu():
			...
			os.system('clear')
			print(logo)
			os.system('xdg-open https://www.facebook.com/md.HASAN.1428')
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/md.HASAN.1428');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
